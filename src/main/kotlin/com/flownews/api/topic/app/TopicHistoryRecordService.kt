...
class TopicHistoryRecordService(
    ...
    private fun recordHistoryInternal(
        req: TopicHistoryRecordRequest,
        userId: Long,
    ) {
    ...
    private fun getTopicHistory(
        req: TopicHistoryRecordRequest,
        userId: Long,
    ): TopicHistory =
        topicHistoryRepository.findByTopicIdAndUserId(req.topicId, userId)
            ?: TopicHistory(
                topicId = req.topicId,
                eventId = req.eventId,
                userId = userId,
