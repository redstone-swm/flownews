...
data class TopicDetailsResponse(
    ...
    companion object {
        ...
        fun fromEntity(topic: Topic, randomTopics: List<Topic>): TopicDetailsResponse = fromEntity(topic, randomTopics, null)
        fun fromEntity(topic: Topic, randomTopics: List<Topic>, topicHistory: TopicHistory?) = TopicDetailsResponse(
            id = topic.id!!,
            title = topic.title,
